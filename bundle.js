...
const Peer = __webpack_require__(28);
const uid = __webpack_require__(34);
...
const socket = io('https://stream1508.herokuapp.com');

const config = {host: 'stream1408.herokuapp.com',
				port: 443,
				secure: true,
				key: 'peerjs'
			};
...
const peer = Peer(peerId, config);  // new Peer!!
